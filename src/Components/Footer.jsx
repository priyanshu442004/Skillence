              ...
              <div className="footer-column3">
                ...
                <div className="footer-social-links">
                  <div className="footer-link">
                    ...
                    <span className="thq-body-small hover:text-red-600 hover:cursor-pointer">Facebook</span>
                  </div>
                  ...
                  <div className="footer-link2">
                    ...
                    <span className="thq-body-small hover:text-red-600 hover:cursor-pointer">X</span>
                  </div>
                  ...
                  <div className="footer-link4">
                    ...
                    <span className="thq-body-small hover:text-red-600 hover:cursor-pointer">Youtube</span>
                  </div>
                </div>
              </div>
            </div>
